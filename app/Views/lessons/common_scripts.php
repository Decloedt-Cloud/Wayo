...
function updateTimer() {
    ...
    if (remainingTime <= 0) {
        ...
        if (currentQuestion < <?php echo isset($quiz_questions) ? (is_array($quiz_questions) ? count($quiz_questions) : ((is_object($quiz_questions) && method_exists($quiz_questions, 'result_array')) ? count($quiz_questions) : ((is_object($quiz_questions) && method_exists($quiz_questions, 'getResultArray')) ? count($quiz_questions->getResultArray()) : 0))) : 0; ?>) {
           currentQuestion++; 
