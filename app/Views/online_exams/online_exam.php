...
$questions = $questions;
$exam_start_timestamp = 0;
if (isset($exam_details['starting_date'])) {
    $raw_start = $exam_details['starting_date'];
    if (is_numeric($raw_start)) {
        $exam_start_timestamp = (int) $raw_start;
    } else {
        $parsed_start = strtotime((string) $raw_start);
        $exam_start_timestamp = $parsed_start ?: 0;
    }
}
?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><strong><?php echo get_phrase('start_time'); ?>:</strong> <?php echo $exam_start_timestamp > 0 ? date('D, d-M-Y H:i', $exam_start_timestamp) : get_phrase('no_date'); ?></p>
...
function submitExam() {
    ...
    .then(data => {
        ...
        document.querySelector('input[name="<?php echo csrf_token(); ?>"]').value = data.csrf_hash;
