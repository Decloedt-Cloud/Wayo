...
<head>
    <meta charset="utf-8" />
    <title><?php echo $page_title; ?> | <?php echo db()->table('schools')->where('id', school_id())->get()->getRowArray()['name'] ?? ''; ?></title>
...
<body class="gray-bg justify-content-center">
    <?php
        ...
        if (file_exists($backend_common_scripts)) {
            include $backend_common_scripts;
        } elseif (file_exists($academy_common_scripts)) {
            include $academy_common_scripts;
        }
    ?>
</body>
</html>