...
<script type="text/javascript">
    toastr.info(<?php echo json_encode($infoMessage); ?>, <?php echo json_encode(get_phrase("info")); ?>);
</script>
<?php endif;?>

<?php if ($errorMessage !== ''):?>
<script type="text/javascript">
    toastr.error(<?php echo json_encode($errorMessage); ?>, <?php echo json_encode(get_phrase("oh_snap")); ?>);
</script>
<?php endif;?>

<?php if ($flashMessage !== ''):?>
<script type="text/javascript">
    toastr.success(<?php echo json_encode($flashMessage); ?>, <?php echo json_encode(get_phrase("success")); ?>);
</script>
<?php endif;?>
</body>
