...
try {
    ...
    $GoogleAPI = $user_model->googleAPI();
} catch (\Exception $e) {
    $GoogleAPI = [];
}
?>
...
<script src="<?php echo base_url()?>assets/frontend/ultimate/js/nav.js?v=<?php echo filemtime(ROOTPATH.'assets/frontend/ultimate/js/nav.js'); ?>" > </script>
