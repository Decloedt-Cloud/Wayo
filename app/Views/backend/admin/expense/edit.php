...
<?php $expense_category_details = db()->table('expense_categories')->where('id', $expense_details['expense_category_id'])->get()->getRowArray(); ?>
...
<div class="exp-form-container">
    ...
    <div class="exp-expense-preview">
        ...
        <div class="exp-preview-info">
            <h4 class="exp-preview-amount"><?php echo $expense_details['amount'].' '.db()->table('settings_school')->where('school_id', school_id())->get()->getRowArray()['system_currency'] ?? ''; ?></h4>
    ...
    <form method="POST" class="d-block ajaxForm" action="<?php echo route('expense/update/'.$param1); ?>">
        ...
        <div class="exp-form-group">
            <label class="exp-form-label">
                ...
                <span><?php echo get_phrase('amount').' ('. db()->table('settings_school')->where('school_id', school_id())->get()->getRowArray()['system_currency'] ?? ''.')'; ?></span>
                <span class="exp-required">*</span>
            </label>
            <div class="exp-input-wrapper">
                <input type="text" 
        ...
        <div class="exp-form-group">
            ...
            <div class="exp-input-wrapper">
                <select class="exp-form-select" name="expense_category_id" id="expense_category_id_on_update" required>
                    ...
                    <?php
                    $expense_categories = $this->crud_model->get_expense_categories();
