<?php 
    ...
    $student_not_found = isset($modal_student_not_found) ? (bool) $modal_student_not_found : empty($student);
    if ($student_not_found): ?>
        <div class="alert alert-danger"><?php echo get_phrase('student_not_found'); ?></div>
        <a href="<?php echo site_url('admin/student'); ?>" class="btn btn-primary"><?php echo get_phrase('go_back'); ?></a>
        <?php return;
    endif;
...
<div class="ec-form-container">
    ...
    <form method="POST" class="d-block" action="<?php echo site_url('admin/student/updated/' . $student_id . '/' . $student['user_id']); ?>" id="student_update_form" enctype="multipart/form-data" novalidate>
        <!-- CSRF Token -->
