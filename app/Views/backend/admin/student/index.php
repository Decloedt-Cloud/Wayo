        ...
        <div class="col-12">
            ...
            <div class="exp-header">
                ...
                <div class="exp-header-actions">
                    <a href="<?php echo site_url('admin/student/create'); ?>" class="exp-btn exp-btn-primary">
                        <i class="mdi mdi-plus"></i>
                        <span><?php echo get_phrase('add_new_student'); ?></span>
                    </a>
                </div>
            </div>
        </div>
...
<script>
    ...
    window.showAllStudents = function () {
        ...
        var currentFilter = $('.exp-chip.active').data('filter');
