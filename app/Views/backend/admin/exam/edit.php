...
$startingDateRaw = $exam['starting_date'] ?? null;
$startingTimestamp = is_numeric($startingDateRaw) ? (int) $startingDateRaw : strtotime((string) $startingDateRaw);
$startingDateValue = $startingTimestamp ? date('Y-m-d\TH:i', $startingTimestamp) : '';
?>
        ...
        <div class="exam-details-section">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control" id="starting_date" name="starting_date" value="<?php echo $startingDateValue; ?>" required>
