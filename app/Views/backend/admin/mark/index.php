...
<?php
$mark_exams = isset($mark_exams) && is_array($mark_exams) ? $mark_exams : [];
$mark_classes = isset($mark_classes) && is_array($mark_classes) ? $mark_classes : [];
?>
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="form-group-modern">
                        <select name="exam" id="exam_id" class="form-control-modern select2" required>
                            ...
                            <?php foreach($mark_exams as $exam){ ?>
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="form-group-modern">
                        <select name="class" id="class_id_mark" class="form-control-modern select2" required>
                            ...
                            <?php foreach($mark_classes as $class){ ?>
                                <option value="<?php echo $class['id']; ?>">
                                    <?php echo $class['name']; ?>
                                    <?php echo "(".(int) ($class['total_students'] ?? 0).")"; ?>
                                </option>
                            <?php } ?>
                        </select>
                    </div>
