...
// Fetch currency
$currencies = db()->table('settings_school')->where('school_id', school_id())->get()->getRowArray()['system_currency'] ?? '' ?? 'EUR';
?>
                ...
                <div class="card-body text-center pt-5">
                    ...
                    <div class="text-start mt-3">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <span class="chip">
                                <?php echo !empty($class['show_on_website']) ? get_phrase('visible_on_website') : get_phrase('not_visible_on_website'); ?>
                            </span>
                        </div>
                    </div>
                    <?php */ ?>
                    ...
                    <div class="row g-2 text-center small">
                        <div class="col-12">
                            <div class="mini-stat">
                                ...
                                <div class="value">
                                    <?php echo $this->user_model->get_user_details($class['user_id'] ?? 0, 'phone'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="info-block">
                                        ...
                                        <div class="info-value">
                                            <?php
                                            echo $this->user_model->get_user_details($class['user_id'] ?? 0, 'Rue')
                                                . ', ' . $this->user_model->get_user_details($class['user_id'] ?? 0, 'Numero')
                                                . ', ' . $this->user_model->get_user_details($class['user_id'] ?? 0, 'Ville')
                                                . ', ' . $this->user_model->get_user_details($class['user_id'] ?? 0, 'Codepostal');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="info-block">
                                        ...
                                        <div class="info-value">
                                            <?php if (!empty($class['social_links'])): ?>
                                                <?php
                                    ...
                                    <div class="info-block">
                                        ...
                                        <div class="info-value">
                                            <span class="badge rounded-pill bg-primary-subtle text-primary fw-semibold">
                                                <?php echo !empty($class['show_on_website']) ? get_phrase('visible') : get_phrase('not_visible'); ?>
                                            </span>
                                        </div>
                                    </div>
                                </div>
