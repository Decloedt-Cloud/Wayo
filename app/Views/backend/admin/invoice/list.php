...
$date_from = isset($date_from) && is_numeric($date_from) ? (int) $date_from : strtotime('-30 days');
$date_to = isset($date_to) && is_numeric($date_to) ? (int) $date_to : time();
$selected_class = isset($selected_class) && $selected_class !== '' ? $selected_class : 'all';
$selected_status = isset($selected_status) && $selected_status !== '' ? $selected_status : 'all';
...
$invoices = $to_rows($this->crud_model->get_invoice_by_date_range($date_from, $date_to, $selected_class, $selected_status));
...
$expenses = $to_rows($this->crud_model->get_expense($date_from, $date_to));
