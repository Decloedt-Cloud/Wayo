...
<div class="ec-form-container">
    ...
    <div class="ec-form-header">
        ...
        <div class="ec-form-title">
            <h3><?php echo get_phrase('update_teacher'); ?></h3>
            <p><?php echo get_phrase('update_teacher_information'); ?></p>
        </div>
    </div>

    <form method="POST" class="d-block ajaxForm" action="<?php echo site_url('app/mentor/update/'.$param1); ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                 ...
                 <div class="ec-form-group">
                    ...
                    <div class="ec-input-wrapper">
                        <input type="text" value="<?php echo $teacher['designation']; ?>" class="ec-form-input" id="designation" name="designation" required>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                 ...
                 <div class="ec-form-group">
                    ...
                    <div class="ec-input-wrapper">
                        <input type="text" class="ec-form-input" name="linkedin_link" value="<?php echo $social_links['linkedin']; ?>">
        ...
        <div class="ec-info-card mt-3">
            ...
            <div class="ec-info-card-content">
                ...
                <p><?php echo get_phrase('provide_teacher_address_information'); ?></p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="ec-form-group">
                    ...
                    <div class="ec-input-wrapper">
                        <textarea class="ec-form-input" id="address" name="address" rows="2" style="height: auto;"><?php echo $user['address']; ?></textarea>
        ...
        <div class="ec-info-card mt-3">
            ...
            <div class="ec-info-card-content">
                <h4><?php echo get_phrase('about_teacher'); ?></h4>
                <p><?php echo get_phrase('provide_a_small_about_description'); ?></p>
            </div>
        </div>
        ...
        <div class="row">
             <div class="col-md-12">
                ...
                <div class="ec-form-group">
                    ...
                    <div class="ec-input-wrapper">
                        <textarea class="ec-form-input" id="about" name="about" rows="3" required style="height: auto;"><?php echo $teacher['about']; ?></textarea>
                        <i class="mdi mdi-comment-text-outline ec-input-icon" style="top: 1.5rem;"></i>
                    </div>
                </div>
            </div>
        </div>
