            ...
            <div class="exp-profile-body">
                ...
                <div class="mb-3">
                    <span class="exp-badge exp-badge-primary">
                        <i class="mdi mdi-briefcase-outline"></i> <?php echo $teacher['designation']; ?>
                    </span>
    ...
    <div class="col-lg-8">
        ...
        <div class="exp-card" style="padding: 1.5rem;">
            <h4 class="exp-section-title">
                <i class="mdi mdi-share-variant-outline"></i> <?php echo get_phrase('social_links'); ?>
            </h4>
                        ...
                        if (is_array($social_links) && !empty($social_links)): ?>
                            <div class="d-flex flex-wrap gap-2">
                                <?php foreach ($social_links as $platform => $url): ?>
                                    <a href="<?php echo htmlspecialchars((string) ($url ?? '')); ?>" target="_blank" class="exp-chip">
                                        <i class="mdi mdi-<?php echo strtolower((string) ($platform ?? 'link')); ?>"></i> <?php echo ucfirst((string) ($platform ?? 'link')); ?>
                                    </a>
                                <?php endforeach; ?>
                            </div>
                        <?php else: ?>
                            <div class="text-muted small"><?php echo get_phrase('no_social_links'); ?></div>
                        <?php endif; ?>
                <?php else: ?>
                    <div class="text-muted small"><?php echo get_phrase('no_social_links'); ?></div>
                <?php endif; ?>
        ...
        <div class="exp-card" style="padding: 1.5rem;">
            ...
            <div class="mb-4">
                <div class="exp-label mb-2"><?php echo get_phrase('about'); ?></div>
                <div class="exp-value" style="font-weight: normal; line-height: 1.6;">
            ...
            <div class="exp-detail-grid">
                ...
                <div class="exp-detail-box">
                     <div class="exp-label"><?php echo get_phrase('visible_on_website'); ?></div>
                     <div class="exp-value">
                        <?php if($teacher['show_on_website']): ?>
                            <span class="text-success"><i class="mdi mdi-eye"></i> <?php echo get_phrase('yes'); ?></span>
                        <?php else: ?>
                            <span class="text-danger"><i class="mdi mdi-eye-off"></i> <?php echo get_phrase('no'); ?></span>
                        <?php endif; ?>
                     </div>
                </div>
            </div>
