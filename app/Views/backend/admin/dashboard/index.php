...
<div class="modern-dashboard">
  ...
  <div class="stats-row">
    ...
    <div class="stat-card students fade-up delay-1">
      ...
      <div class="stat-value" data-count="<?php $students = $this->user_model->get_session_wise_student(); echo count($students); ?>">
    ...
    <div class="stat-card teachers fade-up delay-2">
      ...
      <div class="stat-value" data-count="<?php $teachers = $this->user_model->get_teachers(); echo count($teachers); ?>">
    ...
    <div class="stat-card events fade-up delay-4">
      ...
      <div class="stat-value" data-count="<?php $events_count = $this->crud_model->get_current_month_events(); echo count($events_count); ?>">
        <?php echo count($events_count); ?>
      </div>
    ...
    <div class="modern-card fade-up delay-6">
      ...
      <div class="modern-card-body" style="padding: 0;">
        <div class="modern-table-wrap">
          ...
          $invoices = $this->crud_model->get_invoice_by_date_range($date_from, $date_to, 'all', 'all');
          ?>
