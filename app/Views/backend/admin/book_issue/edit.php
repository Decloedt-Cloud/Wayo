...
<div class="form-group row mb-3">
  ...
  <div class="col-md-9">
    <select name="book_id" id="book_id_on_modal" class="form-control" required>
      ...
      <?php
      $books = $this->crud_model->get_books();
...
<div class="form-group  col-md-12">
  <button class="btn btn-primary btn-l px-4" id="update-btn" type="submit"><i class="mdi mdi-account-check"></i><?php echo get_phrase('update_book_issue_info'); ?></button>
</div>
</form>
