<?php
$student_details = db()->table('students')->where('user_id', session()->get('user_id'))->getResultArray();
$book_issues = $this->crud_model->get_book_issues_by_student_id($student_details['id']); ?>
