...
<div class="adm-form-container">
    <div class="adm-form-header">
        ...
        <div class="adm-form-title">
            <h3><?php echo get_phrase('approve_school'); ?></h3>
            <p><?php echo get_phrase('confirm_school_admission'); ?></p>
        </div>
    </div>
    ...
    <div class="adm-info-card">
        ...
        <div class="adm-info-content">
            ...
            <p><?php echo get_phrase('approving_will_activate_school_account'); ?></p>
        </div>
    </div>
    
    <form method="POST" class="d-block" action="<?php echo site_url('superadmin/online_admission_school/approved'); ?>">
