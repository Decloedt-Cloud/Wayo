                ...
                <form method="POST" class="col-12 profileAjaxForm" action="<?php echo route('profile/update_profile') ; ?>" id = "profileAjaxForm" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                                ...
                                <div class="col-md-5 logo-upload-container">
                                        <div class="logo-card">
                                            ...
                                            <div class="logo-preview" id="profile-image-preview">
                                                    <img src="<?php echo $this->user_model->get_user_image(session()->get('user_id')). '?v=' . time(); ?>" alt="SupperAdmin Profile Image" class="preview-image">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary btn-l px-4"id="update-logos-btn" onclick="updateProfileInfo()"><i class="mdi mdi-account-check"></i><?php echo get_phrase('update_profile') ; ?>
                            </button>
                        </div>
                    </div>
                </form>
