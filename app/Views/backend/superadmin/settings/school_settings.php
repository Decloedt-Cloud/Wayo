...
<div class="mb-3">
    <div class="main-card">
        <div class="card-body">
            ...
            <form method="POST" class="col-12 schoolForm" action="<?php echo site_url('superadmin/school_settings/update'); ?>" id="schoolForm">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-9">
                            <select name="category" id="category" class="form-control" required>
                                ...
                                <?php $categories = db()->table('categories')->getResultArray(); ?>
