  ...
  <tbody>
    ...
    if ($applications) {
      foreach ($applications as $application) {
        $user = db()->table('users')->where('id', $application['user_id'])->get()->getRowArray();
    ?>
        <tr>
          <td>
          ...
          <td>
            <div class="dropdown text-center">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javascript:void(0);" class="dropdown-item" onclick="largeModal('<?php echo site_url('modal/popup/student/profile/' . $application['id']) ?>', '<?php echo db()->table('schools')->where('id', $school_id)->get()->getRow()->name ?? ''; ?>')"><?php echo get_phrase('profile'); ?></a>
                <!-- item-->
