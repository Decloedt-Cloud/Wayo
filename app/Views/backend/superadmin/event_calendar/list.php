	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-body">
				...
				$school_id = db()->table('users')->where('id', $user_id)->get()->getRow()->school_id ?? null;

				?>
				<?php $query = db()->table('announcement')->where('school_id', $school_id)->where('session', active_session()); ?>
