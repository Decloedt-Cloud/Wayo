<div class="gallery_photo_content">
  <?php
  $gallery_photos = db()->table('frontend_gallery_image')->where('frontend_gallery_id', $gallery_id)->get()->getResultArray();
  $gallery_info = db()->table('frontend_gallery')->where('frontend_gallery_id', $gallery_id)->get()->getRowArray();
  ?>
  <div class="row ">
    <div class="col-xl-12">
      <div class="card">
