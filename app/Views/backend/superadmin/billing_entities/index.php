...
foreach ($entities as $entity) {
    $stripe = (is_object($billingEntityCredentialsModel) && method_exists($billingEntityCredentialsModel, 'get_credentials'))
        ? ($billingEntityCredentialsModel->get_credentials($entity['id'], 'stripe') ?? [])
        : [];
    $paypal = (is_object($billingEntityCredentialsModel) && method_exists($billingEntityCredentialsModel, 'get_credentials'))
