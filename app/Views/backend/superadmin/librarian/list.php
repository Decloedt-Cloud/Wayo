<?php
$school_id = school_id();
$check_data = db()->table('users')->where('school_id', $school_id)->where('role', 'librarian')->get()->getResultArray();
...
<table id="basic-datatable" class="table table-striped dt-responsive nowrap" width="100%">
	...
	<tbody>
		<?php
		$users = db()->table('users')->where('school_id', $school_id)->where('role', 'librarian')->get()->getResultArray();
