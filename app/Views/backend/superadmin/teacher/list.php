                    ...
                    <td>
                        <div class="dropdown text-center">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="javascript:void(0);" class="dropdown-item" onclick="largeModal('<?php echo site_url('modal/popup/teacher/profile/'.$teacher['id'])?>', '<?php echo db()->table('schools')->where('id', $school_id)->get()->getRow()->name ?? ''; ?>')"><?php echo get_phrase('profile'); ?></a>
                                <!-- item-->
