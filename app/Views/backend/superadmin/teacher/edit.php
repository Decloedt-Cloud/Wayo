...
foreach($users as $user):
  ...
  ?>
  <form method="POST" class="d-block ajaxForm" action="<?php echo site_url('app/mentor/update/'.$param1); ?>">
    ...
    <div class="form-row">
      ...
      <div class="form-group mt-2 col-md-12">
        <button class="btn btn-primary btn-l px-4" id="update-btn" type="submit"><i class="mdi mdi-account-check"></i><?php echo get_phrase('update_teacher'); ?></button>
      </div>
    </div>
  </form>
<?php endforeach; ?>
