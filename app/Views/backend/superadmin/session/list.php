<?php $check_data = db()->table('sessions')->get();
            ...
            <div class="card-body">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <select class="form-control" id="session_dropdown">
                        ...
                        <?php $sessions = db()->table('sessions')->get()->getResultArray();
                        foreach ($sessions as $session): ?>
                            <option value="<?php echo $session['id']; ?>" <?php if ($session['status'] == 1) echo 'selected'; ?>><?php echo $session['name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-12 mt-1 btncol" style="">
        ...
        <div class="main-card">
            <div class="card-body">
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap table-modern" width="100%">
                    <thead>
                        <tr>
                            <th><i class="mdi mdi-calendar-range-outline me-2 thead-icon"></i><?php echo get_phrase('session_title'); ?></th>
