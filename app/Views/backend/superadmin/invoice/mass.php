...
<div class="edit-form-container">
    ...
    <div class="edit-header">
        ...
        <div class="edit-header-text">
            <h5><?php echo get_phrase('create_mass_invoice'); ?></h5>
            <p><?php echo get_phrase('create_invoices_for_whole_class'); ?></p>
        </div>
    </div>
    ...
    <form method="POST" class="d-block ajaxForm" action="<?php echo route('invoice/mass'); ?>">
        ...
        <div class="edit-section">
            <div class="edit-section-title">
                <i class="fas fa-info-circle"></i> <?php echo get_phrase('target_information'); ?>
            </div>
            ...
            <div class="edit-form-grid full">
                <div class="edit-form-group">
                    ...
                    <select name="class_id" id="class_id_on_create" class="edit-form-control select2" required>
        ...
        <div class="edit-actions">
            ...
            <button type="submit" class="edit-btn edit-btn-primary" id="update-btn">
                <i class="fas fa-plus"></i> <?php echo get_phrase('create_mass_invoice'); ?>
            </button>
        </div>
    </form>
</div>
