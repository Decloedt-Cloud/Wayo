...
$to_datetime_local = static function ($value): string {
    ...
    if (is_string($value) && trim($value) !== '') {
        ...
        if ($parsed !== false) {
            return date('Y-m-d\TH:i', (int) $parsed);
        }
    }
        ...
        <div class="exam-details-section">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control" id="starting_date" name="starting_date" value="<?php echo $to_datetime_local($exam['starting_date'] ?? null); ?>" required>
