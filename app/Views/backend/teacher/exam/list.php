...
$to_timestamp = static function ($value): int {
                        ...
                        <div class="exam-details">
                            ...
                            <div class="exam-meta">
                                <span class="exam-date">
                                    <?php $starting_ts = $to_timestamp($exam['starting_date'] ?? null); ?>
                                    <i class="fas fa-calendar"></i> <?php echo $starting_ts > 0 ? date('D, d-M-Y H:i', $starting_ts) : get_phrase('no_date'); ?>
                                </span>
