    ...
    <div class="col-12">
        <div class="card pt-0">
            <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                <li class="nav-item">
                    <a href="<?php echo site_url('teacher/student/create'); ?>" class="nav-link rounded-0 <?php if($aria_expand == 'single') echo 'active'; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo site_url('teacher/student/create/bulk'); ?>" class="nav-link rounded-0 <?php if($aria_expand == 'bulk') echo 'active'; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo site_url('teacher/student/create/excel'); ?>" class="nav-link rounded-0 <?php if($aria_expand == 'excel') echo 'active'; ?>">
