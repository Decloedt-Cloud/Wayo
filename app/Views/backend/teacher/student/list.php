...
$classes = isset($student_list_classes) && is_array($student_list_classes) ? $student_list_classes : [];
...
$active_count = isset($student_list_active_count) ? (int) $student_list_active_count : 0;
?>
            ...
            <div style="display: flex; gap: 0.5rem;">
                <?php if(addon_status('id-card')):?>
                    <button type="button" class="exp-action-btn" title="<?php echo get_phrase('generate_id_card'); ?>" 
                            onclick="largeModal('<?php echo site_url('modal/popup/student/id_card/'.$student['id'])?>', '<?php echo html_escape($school_name); ?>')"
                ...
                <button type="button" class="exp-action-btn" title="<?php echo get_phrase('profile'); ?>"
                        onclick="largeModal('<?php echo site_url('modal/popup/student/profile/'.$student['id'])?>', '<?php echo html_escape($school_name); ?>')"
                        style="width: 32px; height: 32px; border-radius: 8px; border: none; background: linear-gradient(135deg, #eef2ff, #e0e7ff); color: var(--exp-primary); cursor: pointer; display: flex; align-items: center; justify-content: center;">
                    <i class="mdi mdi-account-circle-outline"></i>
                </button>
                
                <a href="<?php echo site_url('app/mentor/student/edit/'.$student['id']); ?>" class="exp-action-btn" title="<?php echo get_phrase('edit'); ?>"
                   style="width: 32px; height: 32px; border-radius: 8px; border: none; background: linear-gradient(135deg, #eef2ff, #e0e7ff); color: var(--exp-primary); cursor: pointer; display: flex; align-items: center; justify-content: center;">
                ...
                <?php if($student['user_status'] == 1): ?>
                    <button type="button" class="exp-action-btn" title="<?php echo get_phrase('deactivate'); ?>"
                            onclick="confirmModal('<?php echo site_url('app/mentor/student/status/'.$student['id'].'/'.$student['user_id'].'/0'); ?>', showAllStudents, {
                                title: <?php echo htmlspecialchars(json_encode(js_phrase('deactivate_student')), ENT_QUOTES, 'UTF-8'); ?>,
                                text: <?php echo htmlspecialchars(json_encode(js_phrase('are_you_sure_you_want_to_deactivate_this_student')), ENT_QUOTES, 'UTF-8'); ?>,
                                confirmButtonText: <?php echo htmlspecialchars(json_encode(js_phrase('yes_deactivate')), ENT_QUOTES, 'UTF-8'); ?>,
                                requestData: { student_id: <?php echo (int) $student['id']; ?>, user_id: <?php echo (int) $student['user_id']; ?>, new_status: 0 },
                                errorNotificationText: <?php echo htmlspecialchars(json_encode(js_phrase('failed_to_update_status')), ENT_QUOTES, 'UTF-8'); ?>
                            })"
                ...
                <?php else: ?>
                    <button type="button" class="exp-action-btn" title="<?php echo get_phrase('activate'); ?>"
                            onclick="confirmModal('<?php echo site_url('app/mentor/student/status/'.$student['id'].'/'.$student['user_id'].'/1'); ?>', showAllStudents, {
                                title: <?php echo htmlspecialchars(json_encode(js_phrase('activate_student')), ENT_QUOTES, 'UTF-8'); ?>,
                                text: <?php echo htmlspecialchars(json_encode(js_phrase('are_you_sure_you_want_to_activate_this_student')), ENT_QUOTES, 'UTF-8'); ?>,
                                confirmButtonText: <?php echo htmlspecialchars(json_encode(js_phrase('yes_activate')), ENT_QUOTES, 'UTF-8'); ?>,
                                requestData: { student_id: <?php echo (int) $student['id']; ?>, user_id: <?php echo (int) $student['user_id']; ?>, new_status: 1 },
                                errorNotificationText: <?php echo htmlspecialchars(json_encode(js_phrase('failed_to_update_status')), ENT_QUOTES, 'UTF-8'); ?>
                            })"
                ...
                <button type="button" class="exp-action-btn" title="<?php echo get_phrase('delete'); ?>"
                        onclick="confirmModal('<?php echo site_url('app/mentor/student/delete/'.$student['id'].'/'.$student['user_id']); ?>', showAllStudents)"
                        style="width: 32px; height: 32px; border-radius: 8px; border: none; background: linear-gradient(135deg, #fef2f2, #fecaca); color: #dc2626; cursor: pointer; display: flex; align-items: center; justify-content: center;">
