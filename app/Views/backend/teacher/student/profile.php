<?php
    ...
    $user = isset($modal_student_user) && is_array($modal_student_user) ? $modal_student_user : [];
    ...
    $student = array_merge(['id' => 0, 'user_id' => 0, 'code' => ''], $student);
    $user = array_merge([
        'id' => 0,
        'name' => '',
        'status' => 0,
    ...
    $user_id = (int) ($user['id'] ?: $student['user_id']);
            ...
            <div class="mb-4">
                ...
                <div>
                    <?php foreach ($enrols as $enrol): 
                        $class = ['name' => $class_names[(int) $enrol['class_id']] ?? ''];
                        if($class):
                    ?>
                        <span class="exp-chip">
        ...
        <div class="exp-card" style="padding: 1.5rem;">
            ...
            <div class="exp-detail-grid">
                <div class="exp-detail-box">
                    ...
                    <div class="exp-value"><?php echo $user['gender'] !== '' ? get_phrase(strtolower($user['gender'])) : '-'; ?></div>
                </div>
