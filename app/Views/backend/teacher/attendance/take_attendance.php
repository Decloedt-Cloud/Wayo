        ...
        <div class="exp-form-group">
            ...
            <div class="exp-input-wrapper">
                <select name="class_id" id="class_id_on_taking_attendance" class="exp-form-select" required>
                    ...
                    <?php
                    $modal_attendance_classes = is_array($modal_attendance_classes ?? null) ? $modal_attendance_classes : [];
                    foreach ($modal_attendance_classes as $class):
...
<script>
    ...
    function getStudentList() {
        ...
        var csrfName = $('#right-modal input[name="<?= csrf_token(); ?>"]').attr('name');
        var csrfHash = $('#right-modal input[name="<?= csrf_token(); ?>"]').val();
