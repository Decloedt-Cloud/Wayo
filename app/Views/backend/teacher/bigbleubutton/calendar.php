                ...
                <form id="appointmentForm">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="section[]" id="section" multiple>
                            <?php 
                            $sections = db()->table('sections')->where('class_id', $classe_id)->get()->getResultArray();
        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            select: function (start, end, allDay) {
                ...
                if (clicked.isBefore(now, 'day')) {
                    Swal.fire({
                        icon: 'warning',
                        title: '<?php echo get_phrase("Date invalide") ?>',
                        text: '<?php echo get_phrase("Impossible d’ajouter un rendez-vous à une date passée.") ?>',
