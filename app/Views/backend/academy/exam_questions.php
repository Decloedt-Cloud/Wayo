...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/backend/css/manageQuizQuestions.min.css">
<style>
...
<?php
// $param1 is Exam id
$exam_details = isset($exam_details) ? $exam_details : null;
...
function saveExamQuestions() {
    ...
    var csrfName = csrfInput ? csrfInput.name : '<?php echo csrf_token(); ?>';
    var csrfHash = csrfInput ? csrfInput.value : '<?php echo csrf_hash(); ?>';
