<?php
    ...
    $section_details = $this->lms_model->get_section('section', $param1);
?>
...
.section-modal-form .section-info {
    display: flex;
    align-items: center;
    gap: 10px;
    padding: 12px 14px;
...
.section-modal-form .section-info i {
    color: #6366f1;
    font-size: 1.2rem;
}
.section-modal-form .section-info span {
    color: #64748b;
    font-size: 0.85rem;
}
.section-modal-form .section-info strong {
    color: #1e293b;
}
</style>

<form action="<?php echo site_url('addons/courses/course_sections/'.$param2.'/edit/'.$param1); ?>" method="post" class="section-modal-form">
