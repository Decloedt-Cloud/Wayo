        ...
        <div class="auth-fluid-form-box">
            <div class="align-items-center d-flex h-100">
                <div class="card-body">
                    ...
                    <!-- title-->
                    <h4 class="mt-0"><?php echo get_phrase('add_new_password'); ?></h4>
                    <p class="text-muted mb-4"><?php echo get_phrase('enter_your_new_password_to_access_account'); ?>.</p>



                    <form action="<?php echo base_url('login/add_new_password?user_id=' . $this->request->getGet('user_id')); ?>" method="POST">
                    ...
                    <input type="hidden" name="<?=csrf_token();?>" value="<?=csrf_hash();?>" />
                        ...
                        <div class="form-group mb-3 mb-0 text-center">
                            <button class="btn btn-primary btn-block" type="submit"><i class="mdi mdi-login"></i> <?php echo get_phrase('add_new_password'); ?> </button>
                        </div>
                    </form>
                    <!-- end form-->
                </div> <!-- end .card-body -->
...
<?php if ($flashMessage !== ''):?>
    <script type="text/javascript">
    $.NotificationApp.send("<?php echo get_phrase('congratulations'); ?>!", '<?php echo $flashMessage; ?>' ,"top-right","rgba(0,0,0,0.2)","success");
</script>
<?php endif;?>
</body>
