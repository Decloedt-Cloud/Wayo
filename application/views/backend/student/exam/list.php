                ...
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap table-modern" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><i class="mdi mdi-link-variant thead-icon"></i><?php echo get_phrase('link'); ?></th>
                        </tr>
                    </thead>
    ...
    $(document).ready(function() {
        ...
        function initDataTable() {
            $('#basic-datatable').DataTable({
                ...
                lengthMenu: [
                    [5, 10, 25, 50, -1],
                    [5, 10, 25, 50, "<?php echo get_phrase('all'); ?>"]
                ],
                dom: 'lfrtip',
                info: true,
                language: {
        ...
        function loadInitialExams(class_id, date_filter = '') {
            ...
            console.log('loadInitialExams appelé avec : ', {
                class_id,
                date_filter,
                csrf_token
            });
            ...
            if (class_id) {
                ...
                console.warn('Données manquantes pour loadInitialExams : ', {
                    class_id
                });
...
<style>
    ...
    .table-container {
        ...
        /* Centrer horizontalement et marge en bas */
    }

    /* Style pour le conteneur du calendrier */
    .calendar-container {
        max-width: 1185px;
        /* Largeur maximale du calendrier */
        margin: 0 auto;
    ...
    .dataTables_length {
        ...
        /* S'assurer que le sélecteur "Show entries" est visible */
    }

    .dataTables_info {
        padding-top: 10px;
        /* Ajouter un peu d'espace pour les informations de pagination */
    }
