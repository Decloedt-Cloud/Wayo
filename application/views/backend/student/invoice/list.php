                        ...
                        <td>
                            <div class="d-flex gap-2">
                                ...
                                <?php else: ?>
                                    ...
                                    <a href="<?php echo route('invoice_pdf/' . $invoice['id']); ?>" class="modern-btn" style="background: #F4F7FE; color: var(--text-color); padding: 0.5rem 1rem; font-size: 0.85rem;" target="_blank">
