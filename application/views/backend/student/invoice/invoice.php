  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="float-start mt-3">
              ...
              <p><b><?php echo get_phrase('school'); ?></b> : <?php echo $school['name']; ?></p>
              <?php echo get_phrase('Rue') .' : ' . $student_details['Rue']; ?><br>
              <?php echo get_phrase('Numero') .' : ' . $student_details['Numero']; ?><br>
              <?php echo get_phrase('Ville') .' : ' . $student_details['Ville']; ?><br>
              <?php echo get_phrase('Codepostal') .' : ' . $student_details['Codepostal']; ?> 
        ...
        <div class="row mt-4">
          <div class="col-sm-4">
            <h6><?php echo get_phrase('billing_details').' '.get_phrase('membre'); ?></h6>
            <address>
              <?php echo $student_details['name']; ?><br>
              <?php echo get_phrase('Rue') .' : ' . $student_details['Rue']; ?><br>
              <?php echo get_phrase('Numero') .' : ' . $student_details['Numero']; ?><br>
              <?php echo get_phrase('Ville') .' : ' . $student_details['Ville']; ?><br>
              <?php echo get_phrase('Codepostal') .' : ' . $student_details['Codepostal']; ?><br>
              <abbr title="Phone"><?php echo get_phrase('Phone') .' : '; ?></abbr> <?php echo $student_details['phone'] == "" ? '('.get_phrase('phone_number_not_found').')' : $student_details['phone']; ?><br>
            </address>
          </div> <!-- end col-->
        </div>
        <!-- end row -->
        ...
        <div class="row">
          ...
          <div class="d-print-none mt-4">
            <div class="text-end">
              ...
              <a href="<?php echo site_url('student/invoice_pdf/'.$invoice_details['id']); ?>" class="btn btn-success ms-1">
