...
<style>
/* ============================================================================
   TEACHER MANAGER - MODERN DESIGN (MATCHING ADMIN STYLE)
   ============================================================================ */
        ...
        <div class="exp-header">
            <div class="exp-header-left">
                ...
                <div class="exp-header-text">
                    ...
                    <p><?php echo get_phrase('view_teacher_details'); ?></p>
                </div>
            </div>
            <div class="exp-header-actions">
                <!-- Teachers cannot add other teachers -->
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    window.showAllTeachers = function () {
        ...
        $.ajax({
            url: '<?php echo route('teacher/list') ?>',
