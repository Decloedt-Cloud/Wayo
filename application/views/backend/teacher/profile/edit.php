            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="modern-form-group">
                        <label class="modern-label" for="name"><?php echo get_phrase('name'); ?> <span class="required">*</span></label>
                ...
                <div class="col-md-6">
                    <div class="modern-form-group">
                        ...
                        <input type="email" id="email" name="email" class="modern-input" value="<?php echo $profile_data['email']; ?>" required readonly>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="modern-form-group">
                        <label class="modern-label" for="address"><?php echo get_phrase('address'); ?></label>
                        <textarea id="address" name="address" class="modern-input" rows="5"><?php echo $profile_data['address']; ?></textarea>
                    </div>
                </div>
                        ...
                        <div class="d-flex align-items-center gap-4 mt-2">
                            <div class="position-relative" style="width: 100px; height: 100px;">
                                <div class="logo-preview" id="profile-image-preview" style="width: 100%; height: 100%; border-radius: 50%; overflow: hidden; border: 3px solid var(--border-color); box-shadow: var(--shadow-sm);">
                                    <img src="<?php echo $this->user_model->get_user_image($this->session->userdata('user_id')). '?v=' . time(); ?>" alt="Profile Image" class="preview-image" style="width: 100%; height: 100%; object-fit: cover;">
                                </div>
                            </div>
