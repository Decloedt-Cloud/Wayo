    ...
    <div class="card-body d-flex justify-content-between align-items-center">
      ...
      <div class="action-buttons-container">
        ...
        <?php if (addon_status('biometric-attendance')): ?>
          <button type="button" class="btn-modern btn btn-outline-info btn-rounded alignToTitle float-end my-1 me-1" onclick="rightModal('<?php echo site_url('modal/popup/attendance/biometric_attendance'); ?>', '<?php echo get_phrase('import_biometric_attendance'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('biometric_attendance'); ?></button>
        <?php endif; ?>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
      ...
      <div class="main-card">
        <div class="card-body">
          <div class="row mt-3 d-print-none">
            ...
            <div class="col-md-2 mb-1">
              <select name="class" id="class_id_teacher" class="form-control" required>
