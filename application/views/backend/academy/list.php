                ...
                ?>
                    <div class="aca-list-item">
                        ...
                        <div class="aca-col-stats">
                            <div><i class="mdi mdi-folder-outline"></i> <?php echo $sections->num_rows(); ?> <?php echo get_phrase('sections'); ?></div>
                            <div><i class="mdi mdi-file-document-outline"></i> <?php echo $lessons->num_rows(); ?> <?php echo get_phrase('lessons'); ?></div>
                        </div>
