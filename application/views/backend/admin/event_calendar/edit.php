    ...
    <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" />
        ...
        <div class="form-row">
            ...
            <div class="form-group mb-1">
                ...
                <input type="date" value="<?php echo date('Y-m-d', strtotime($announcement['starting_date'])); ?>" class="form-control" id="starting_date" name = "starting_date"  required>
            ...
            <div class="form-group mb-1">
                ...
                <input type="date" value="<?php echo date('Y-m-d', strtotime($announcement['ending_date'])); ?>" class="form-control" id="ending_date" name = "ending_date" required>
