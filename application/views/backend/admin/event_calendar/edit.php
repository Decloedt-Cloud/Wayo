...
<style>
/* ============================================================================
   PREMIUM FORM DESIGN - EVENT EDIT
   ============================================================================ */
...
<?php 
$announcements = $this->db->get_where('announcement', array('id' => $param1))->result_array(); 
...
<div class="exp-form-container">
    ...
    <div class="exp-form-header">
        ...
        <div class="exp-form-title">
            <h3><?php echo get_phrase('update_event'); ?></h3>
            <p><?php echo get_phrase('update_event_details'); ?></p>
        </div>
    </div>
    ...
    <form method="POST" class="d-block ajaxForm" action="<?php echo route('event_calendar/update/'.$param1); ?>">
        ...
        <div class="exp-form-group">
            ...
            <div class="exp-editor-wrapper">
                <div id="quill-editor"><?php echo isset($announcement['content']) ? $announcement['content'] : ''; ?></div>
                <input type="hidden" name="content" id="content" value="<?php echo isset($announcement['content']) ? htmlspecialchars($announcement['content']) : ''; ?>">
            </div>
        </div>
        ...
        <div class="exp-form-group">
            ...
            <div class="exp-input-wrapper">
                <input type="date" 
                       ...
                       id="starting_date" 
                       name="starting_date" 
                       value="<?php echo date('Y-m-d', strtotime($announcement['starting_date'])); ?>"
                       required>
        ...
        <div class="exp-form-group">
            ...
            <div class="exp-input-wrapper">
                <input type="date" 
                       ...
                       id="ending_date" 
                       name="ending_date" 
                       value="<?php echo date('Y-m-d', strtotime($announcement['ending_date'])); ?>"
                       required>
        ...
        <div class="exp-form-actions">
            <button type="submit" class="exp-btn exp-btn-primary" id="submit-btn">
                ...
                <span><?php echo get_phrase('update_event'); ?></span>
            </button>
        </div>
    </form>
</div>
...
$(document).ready(function() {
    ...
    function resetButton() {
        submitBtn.prop('disabled', false)
            ...
            .html('<i class="mdi mdi-content-save"></i> <span><?php echo get_phrase('update_event'); ?></span>')
            .css({
                'background': '',
                'box-shadow': ''
            });
