...
<form method="POST" class="d-block" action="<?php echo route('student/create_single_student/submit'); ?>" id="single_student_admission_form" enctype="multipart/form-data" novalidate>
    <!-- CSRF Token -->
