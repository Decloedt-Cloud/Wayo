...
<body>
        ...
        <table class="header-table">
            <tr>
                <td class="header-left">
                    ...
                    <?php endif; ?>
                    <span class="header-company"><?php echo esc_admin($school['name']); ?></span>
                </td>
            ...
            <tr>
                <td class="billing-cell" style="padding-right: 8px;">
                    <div class="billing-box">
                        ...
                        <div class="billing-name"><?php echo esc_admin($school['name']); ?></div>
                        <div class="billing-details">
                            <?php if (!empty($school['Rue'])): ?>
                                <?php echo esc_admin($school['Rue']); ?> <?php echo esc_admin($school['Numero']); ?><br>
                            <?php endif; ?>
                            <?php echo esc_admin($school['Codepostal']); ?> <?php echo esc_admin($school['Ville']); ?>
                            <?php if (!empty($school['num_vat'])): ?>
                                <br>N° TVA: <?php echo esc_admin($school['num_vat']); ?>
                            <?php endif; ?>
                        </div>
                    </div>
                </td>
                <td class="billing-cell" style="padding-left: 8px;">
                    <div class="billing-box client">
                        ...
                        <div class="billing-name"><?php echo esc_admin($student_details['name']); ?></div>
                        <div class="billing-details">
                            <?php if (!empty($student_details['Rue'])): ?>
                                <?php echo esc_admin($student_details['Rue']); ?> <?php echo esc_admin($student_details['Numero']); ?><br>
                            <?php endif; ?>
                            <?php if (!empty($student_details['Codepostal']) || !empty($student_details['Ville'])): ?>
                                <?php echo esc_admin($student_details['Codepostal']); ?> <?php echo esc_admin($student_details['Ville']); ?><br>
                            <?php endif; ?>
                            <?php if (!empty($student_details['email'])): ?>
                                <?php echo esc_admin($student_details['email']); ?>
                            <?php endif; ?>
                        </div>
                    </div>
                </td>
        ...
        <table class="meta-table">
            <tr>
                ...
                <td class="meta-cell">
                    ...
                    <div class="meta-value"><?php echo !empty($invoice_details['payment_method']) ? esc_admin(ucfirst($invoice_details['payment_method'])) : '—'; ?></div>
                </td>
                <td class="meta-cell">
    ...
    <table class="items-table">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <div class="item-name"><?php echo esc_admin($invoice_details['title']); ?></div>
                    <?php if ($class_details): ?>
                        <div class="item-description">Classe: <?php echo esc_admin($class_details['name']); ?></div>
                    <?php endif; ?>
                    <?php if (!empty($invoice_details['description'])): ?>
                        <div class="item-description"><?php echo esc_admin($invoice_details['description']); ?></div>
                    <?php endif; ?>
                </td>
        ...
        <div class="info-box fx">
            ...
            <div class="info-box-content">
                ...
                <div class="info-row">
                    ...
                    <span class="info-row-value"><?php echo number_format($payment_amount_converted, 2, ',', ' '); ?> <?php echo esc_admin($payment_currency); ?></span>
                </div>
                <?php if ($fx_rate): ?>
                <div class="info-row">
                    <span class="info-row-label">Taux de change:</span>
                    <span class="info-row-value">1 <?php echo $invoice_currency; ?> = <?php echo number_format($fx_rate, 4); ?> <?php echo esc_admin($payment_currency); ?></span>
                </div>
                <?php endif; ?>
                <?php if ($fx_rate_date): ?>
                <div class="info-row">
        ...
        <div class="info-box payment">
            ...
            <div class="info-box-content">
                <div class="info-row">
                    ...
                    <span class="info-row-value"><?php echo esc_admin(ucfirst($invoice_details['payment_method'])); ?></span>
                </div>
                <?php if ($payment_date): ?>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="info-row-value">
                        ...
                        if ($conversion_applied && $payment_amount_converted) {
                            echo number_format($payment_amount_converted, 2, ',', ' ') . ' ' . esc_admin($payment_currency);
                        } else {
    ...
    <htmlpagefooter name="myfooter">
        <div class="pdf-footer">
            <span class="pdf-footer-company"><?php echo esc_admin($school['name']); ?></span>
            <?php if (!empty($school['email'])): ?> • <?php echo esc_admin($school['email']); ?><?php endif; ?>
            <?php if (!empty($school['phone'])): ?> • <?php echo esc_admin($school['phone']); ?><?php endif; ?>
