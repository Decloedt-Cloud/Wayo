...
<div class="mark-stats-container">
    <div class="mark-stat-card">
        ...
        <div class="mark-stat-info">
            ...
            <small class="text-muted"><?php echo date('d M Y', $exam_details['starting_date']); ?></small>
        </div>
    </div>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            ...
                            <span class="font-weight-bold"><?php echo $this->user_model->get_user_details($student['user_id'], 'name'); ?></span>
                        </div>
                    </td>
                    <td>
