...
<?php if ($working_page == 'filter'): ?>
    ...
    <style>
    /* ============================================================================
       LIBRARIAN MANAGER - MODERN DESIGN (MATCHING TEACHER/ACCOUNTANT STYLE)
       ============================================================================ */
    ...
    .exp-list-header {
        display: grid;
        grid-template-columns: 0.5fr 1.5fr 2fr 1fr 0.8fr;
        padding: 1rem 1.5rem;
            ...
            <div class="exp-header">
                <div class="exp-header-left">
                    ...
                    <div class="exp-header-text">
                        <h4><?php echo get_phrase('librarians'); ?></h4>
                        <p><?php echo get_phrase('manage_librarian_details'); ?></p>
                    </div>
                </div>
                <div class="exp-header-actions">
                    <button type="button" class="exp-btn exp-btn-primary" onclick="rightModal('<?php echo site_url('modal/popup/librarian/create'); ?>', '<?php echo get_phrase('create_librarian'); ?>')">
                        <i class="mdi mdi-plus"></i>
                        <span><?php echo get_phrase('add_new_librarian'); ?></span>
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="exp-content-card">
                <div class="exp-content-header">
                    <span class="exp-content-title">
                        ...
                        <?php echo get_phrase('librarian_list'); ?>
                    </span>
                </div>
                <div class="exp-content-body librarian_content">
...
<script>
    ...
    $('document').ready(function () {
        // Charger tous les bibliothécaires au démarrage
        if(typeof window.showAllLibrarians === 'function') {
            //window.showAllLibrarians();
        }
    });

    window.showAllLibrarians = function () {
        // Visual feedback
        $('.librarian_content').css('opacity', '0.5');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('.librarian_content').html(response).css('opacity', '1');
            ...
            error: function(xhr, status, error) {
                ...
                $('.librarian_content').css('opacity', '1');
                if(typeof toastr !== 'undefined') {
