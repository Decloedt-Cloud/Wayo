<?php 
/**
 * Invoice Edit - Modern Design (Superadmin)
 */
...
<div class="edit-form-container">
    ...
    <form method="POST" class="ajaxForm" id="editInvoiceForm" action="<?php echo route('invoice/update/'.$param1); ?>">
        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" id="csrf_edit" />
