...
<style>
/* ============================================================================
   ONLINE ADMISSION SCHOOL - MODERN DESIGN
   ============================================================================ */
...
<div class="adm-header">
    <div class="adm-header-left">
        ...
        <div class="adm-header-text">
            <h4><?php echo get_phrase('online_admission_school'); ?></h4>
            <p><?php echo get_phrase('manage_school_admission_applications'); ?></p>
        </div>
    </div>
</div>
...
<div class="adm-content-card">
    <div class="adm-content-header">
        <span class="adm-content-title">
            ...
            <?php echo get_phrase('school_applications'); ?>
        </span>
    </div>
