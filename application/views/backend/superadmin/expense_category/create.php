<style>
/* ============================================================================
   EXPENSE CATEGORY CREATE - MODERN FORM DESIGN
   ============================================================================ */
:root {
    --edit-primary: #6366f1;
...
<div class="edit-form-container">
    ...
    <div class="edit-header">
        ...
        <div class="edit-header-text">
            <h5><?php echo get_phrase('add_expense_category'); ?></h5>
            <p><?php echo get_phrase('create_new_expense_category'); ?></p>
        </div>
    </div>
    ...
    <form method="POST" class="d-block ajaxForm" action="<?php echo route('expense_category/create'); ?>">
        ...
        <div class="edit-section">
            <div class="edit-section-title">
                <i class="fa-solid fa-circle-info"></i> <?php echo get_phrase('category_details'); ?>
            </div>

            <div class="edit-form-grid full">
                <div class="edit-form-group">
                    <label class="edit-form-label" for="name">
                        <i class="fa-solid fa-signature"></i> <?php echo get_phrase('expense_category_name'); ?>
                        <span class="required"> * </span>
                    </label>
                    <input type="text" class="edit-form-control" id="name" name="name" required>
                </div>
            </div>
        </div>
        ...
        <div class="edit-actions">
            ...
            <button class="edit-btn edit-btn-primary" id="update-btn" type="submit">
                <i class="fa-solid fa-floppy-disk"></i> <?php echo get_phrase('save_expense_category'); ?>
            </button>
        </div>
    </form>
</div>
