    ...
    <table id="basic-datatable" class="table table-striped dt-responsive nowrap table-modern" width="100%">
        <thead>
            <tr>
                ...
                <th><i class="mdi mdi-account-cog-outline thead-icon "></i><?php echo get_phrase('admin_of'); ?></th>
                ...
                <tr>
                    ...
                    <td class="modern-td">
                        ...
                        <span class="desktop-description"
                            ...
                            <?php echo strlen($admin['email']) > 30 ? substr($admin['email'], 0, 30) . '...' : $admin['email']; ?>
                        </span>
                        <span class="d-inline d-md-none ms-2">
                            <?php echo strlen($admin['email']) > 13 ? substr($admin['email'], 0, 13) . '...' : $admin['email']; ?>
                        </span>

                        <button type="button" class="btn btn-sm mobile-description-btn"
                            data-description="<?php echo htmlspecialchars($admin['email']); ?>"
                    ...
                    <td>
                        ...
                        ?>
                            ...
                            <br><small> <strong><i class="mdi mdi-phone-outline thead-icon"></i><?php echo get_phrase('phone'); ?></strong>: <?php echo $school_details['phone']; ?></small>
                            <br><small> <strong><i class="mdi mdi-map-marker-outline thead-icon"></i><?php echo get_phrase('address'); ?></strong>: <?php echo $school_details['address']; ?></small>
                        <?php } ?>
                    </td>
                    <td>
