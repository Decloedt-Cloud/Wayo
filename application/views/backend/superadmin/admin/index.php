...
<style>
/* ============================================================================
   ADMIN INDEX - MODERN DESIGN (Adapted from Invoice Index)
   ============================================================================ */
:root {
    --idx-primary: #6366f1;
...
<div class="idx-header">
    <div class="idx-header-left">
        ...
        <div class="idx-header-text">
            <h4><?php echo get_phrase('all_admins'); ?></h4>
            <p><?php echo get_phrase('manage_system_administrators'); ?></p>
        </div>
    </div>
    <div class="idx-header-actions">
        <button type="button" class="idx-btn idx-btn-primary" onclick="rightModal('<?php echo site_url('modal/popup/admin/create'); ?>', '<?php echo get_phrase('create_admin'); ?>')">
            <i class="fa-solid fa-plus"></i>
            <span><?php echo get_phrase('create_admin'); ?></span>
        </button>
    </div>
</div>
