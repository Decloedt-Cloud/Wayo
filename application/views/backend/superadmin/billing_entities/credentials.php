...
<?php
$CI =& get_instance();
$CI->load->model('BillingEntityCredentials_model', 'credentials_model');
$stripe_creds = $CI->credentials_model->get_credentials($entity['id'], 'stripe');
$paypal_creds = $CI->credentials_model->get_credentials($entity['id'], 'paypal');
?>
