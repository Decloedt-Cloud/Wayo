...
<script>
                    ...
                    data.active_meetings.forEach(meeting => {
                        ...
                        if (statusElement) {
                            statusElement.innerHTML = isRunning ?
                                `<span class="badge bg-success"><h5><?php echo get_phrase("En Cours") ?></span>` :
                        ...
                        if (copyButton) {
                            if (meetingID) {
                                let meetingLink = "<?php // echo base_url('bigbluebutton/join_meeting/'); 
                                                    ?>" + meetingID;
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("confirmDeleteBtn_room").addEventListener("click", async function(event) {
            ...
            if (!selectedRoomID) {
                console.error("❌ <?php echo get_phrase("Error: No room ID selected !") ?>");
