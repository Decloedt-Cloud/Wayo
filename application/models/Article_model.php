...
class Article_model extends CI_Model {
    ...
    public function get_articles($limit = null, $offset = 0) {
        ...
        // ou on peut simuler des données pour le design
    ...
    public function get_articles_by_category($category_slug) {
        ...
        return $this->db->get_where('articles', ['category_slug' => $category_slug])->result_array();
    }
    ...
    public function get_articles_by_tag($tag_slug) {
        ...
        // Simulation d'une recherche par tag (souvent via une table pivot, mais simplifions ici)
        $this->db->like('tags', $tag_slug);
        return $this->db->get('articles')->result_array();
    }
    ...
    private function get_mock_data() {
        return [
            ...
            'content' => '
                ...
                <p>ClawdBot reflects how AI is accelerating content creation and making it accessible to a wider audience. However, the future lies not only in producing content faster, but in transforming that content into structured learning experiences and engaged communities.
                By combining AI-assisted creation with course building and community management, platforms like Wayo illustrate how creators can move from content generation to long-term value creation.</p>',
