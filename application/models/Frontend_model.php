...
class Frontend_model extends CI_Model
{
  ...
  function send_contact_message()
  {
    ...
    $msg .= ".container { background: #ECECEC; padding: 30px 15px; }";
    $msg .= ".logo { text-align: center; margin-bottom: 20px; }";
    $msg .= ".logo img { max-width: 150px; height: auto; }";
    $msg .= ".content-table { max-width: 700px; width: 100%; margin: 0 auto; border-collapse: collapse; }";
    $msg .= ".header { background: #D2822D; border-radius: 15px 15px 0 0; padding: 15px; text-align: center; }";
    ...
    $msg .= ".header span { font-size: 18px; }";
    $msg .= ".footer td { display: block; text-align: center !important; width: 100% !important; }";
    $msg .= "}";
    $msg .= "</style>";
    $msg .= "</head>";
    $msg .= "<body>";
    $msg .= "<div class='container'>";
    $msg .= "<div class='logo'><img src='https://wayo.academy/uploads/system/logo/logo-light.png' alt='Wayo Academy Logo'></div>";
    $msg .= "<table class='content-table'>";
    $msg .= "<tr>";
    ...
    $msg .= "<table>";
    $msg .= "<tr>";
    $msg .= "<td style='text-align: left; width: 33%;'><a href='https://wayo.academy/home/contact#map' style='color: #fff; text-decoration: none;'>R320 Umm Hurair 2 Dubai UAE</a></td>";
    $msg .= "<td style='text-align: center; width: 33%;'>© All the rights reserved to Wayo Academy</td>";
    $msg .= "<td style='text-align: right; width: 33%;'>Tel: <a href='tel:+971501548923' style='color: #fff; text-decoration: none;'>+971 50 154 8923</a></td>";
    $msg .= "</tr>";
    $msg .= "</table>";
    $msg .= "</td>";
    $msg .= "</tr>";
