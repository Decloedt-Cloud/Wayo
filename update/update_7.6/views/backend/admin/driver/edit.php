<?php
$user = $this->db->where('id', $param1)->get('users')->row_array();
$driver = $this->db->where('user_id', $user['id'])->get('drivers')->row_array();
$social_links = json_decode($driver['social_links'], true);
?>
<form method="POST" class="d-block ajaxForm" action="<?php echo route('driver/update/' . $param1); ?>" enctype="multipart/form-data">
    <div class="form-row">
        ...
        <div class="form-group mb-1">
            ...
            <textarea class="form-control" id="about" name="about" rows="5" required><?php echo $driver['about']; ?></textarea>
