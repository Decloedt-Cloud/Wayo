<?php
$vehicle_details = $this->db->get_where('vehicles', array('id' => $param1))->row_array();
...
<form method="POST" class="d-block ajaxForm" action="<?php echo route('vehicle/update/' . $param1); ?>" enctype="multipart/form-data">
    <div class="form-row">
        <div class="form-group mb-1">
            <input type="hidden" name="school_id" value="<?php echo school_id(); ?>">
            <label for="vehicle_number"><?php echo get_phrase('vehicle_number'); ?></label>
            <input type="text" class="form-control" id="vehicle_number" name="vh_num" value="<?php echo $vehicle_details['vh_num']; ?>" required>
        ...
        <div class="form-group mb-1">
            ...
            <input type="text" class="form-control" id="vehicle_model" name="vh_model" value="<?php echo $vehicle_details['vh_model']; ?>" required>
        ...
        <div class="form-group mb-1">
            ...
            <input type="text" class="form-control" id="chassis_number" name="vh_chassis" value="<?php echo $vehicle_details['vh_chassis']; ?>" required>
        ...
        <div class="form-group mb-1">
            ...
            <input type="number" class="form-control" id="seat_capacity" name="capacity" value="<?php echo $vehicle_details['capacity']; ?>" required>
        ...
        <div class="form-group mb-1">
            ...
            <select name="driver" id="driver" class="form-control"  required>
                ...
                <option value="<?php echo $driver['id'] ?>" <?php if ($driver['id'] == $vehicle_details['driver']) : ?> selected <?php endif; ?>><?php echo $driver['name'] ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="form-group mb-1">
            ...
            <input type="text" class="form-control" id="route" name="route" value="<?php echo $vehicle_details['route']; ?>" required>
