  ...
  public function class_room($param1 = '', $param2 = '', $param3 = '')
    {
      ...
      echo json_encode(array('status' => $response, 'csrf' => $csrf));
       ...
       if ($param1 == 'list') {
          return view('backend/superadmin/class_room/list');
        }
    ...
    $this->output->set_content_type('application/json')->set_output(json_encode($response));
      ...
      public function delete_appointment_and_recording($appointment_id)
      {
          ...
          if (empty($appointment_id)) {
              ...
              return redirect()->to(site_url('superadmin/Recording'));
              return;
          }
  ...
  public function exam($param1 = '', $param2 = '')
{
    ...
    if ($param1 == 'list') {
        return view('backend/superadmin/exam/list');
    }
 ...
 if ($param1 == 'active') {
  ...
  public function online_admission($param1 = "", $user_id = "")
  {
    ...
    if ($param1 == 'assigned') {
      ...
      return redirect()->to(site_url('superadmin/online_admission'));
  ...
  public function online_admission_school($param1 = "", $school_id = "")
  {
    ...
    if ($param1 == 'approved') {
      ...
      $this->session->set_flashdata('flash_message', get_phrase('admission_request_has_been_updated'));
      return redirect()->to(site_url('superadmin/online_admission_school'));
    }
    if ($param1 == 'delete') {
  ...
  public function exam_results($exam_id = "", $student_id = "") {
    try {
        ...
        if (!$this->session->userdata('superadmin_login') || $this->session->userdata('user_type') != 'superadmin') {
            return redirect()->to(site_url('login'));
        }
        ...
        if (!$exam) {
            return redirect()->to(site_url('superadmin/exam'));
        }
